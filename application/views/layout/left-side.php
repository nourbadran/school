                ...
                <ul class="nav side-menu">                    
                    ...
                    <?php if($this->session->userdata('role_id') != SUPER_ADMIN){ ?>
                        <?php if(has_permission(VIEW, 'setting', 'setting') || has_permission(VIEW, 'setting', 'payment')  || has_permission(VIEW, 'setting', 'sms')){ ?> 
                            <li><a><i class="fa fa-gears"></i> <?php echo $this->lang->line('school'); ?> <?php echo $this->lang->line('setting'); ?> <span class="fa fa-chevron-down"></span></a>
                    ...
                    <?php if(has_permission(VIEW, 'administrator', 'school') || has_permission(VIEW, 'administrator', 'year') || has_permission(VIEW, 'administrator', 'role') || has_permission(VIEW, 'administrator', 'permission') || has_permission(VIEW, 'administrator', 'user') || has_permission(EDIT, 'administrator', 'password') || has_permission(VIEW, 'administrator', 'backup')){ ?>    
                    ...
                    <?php if(has_permission(VIEW, 'academic', 'routine')){ ?>
                        ...
                        <?php }else{ ?>    
                            <li> <a <?php if(empty($classes)){ ?> onclick="alert('<?php echo $this->lang->line('class_add_alert'); ?>');" <?php } ?>> <i class="fa fa-clock-o"></i> <?php echo $this->lang->line('class'); ?> <?php echo $this->lang->line('routine'); ?> <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <?php foreach($classes as $obj){ ?>
                                        <?php if($this->session->userdata('role_id') == STUDENT && $this->session->userdata('class_id') == $obj->id){ ?>
                    ...
                    <?php if(has_permission(VIEW, 'assignment', 'assignment')){ ?>
                        ...
                        <?php }else{ ?>
                            <li>  <a <?php if(empty($classes)){ ?> onclick="alert('<?php echo $this->lang->line('class_add_alert'); ?>');" <?php } ?>><i class="fa fa-file-word-o"></i> <?php echo $this->lang->line('assignment'); ?> <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">                                                                                                                   
                                    <?php foreach($classes as $obj){ ?>
                                        <?php if($this->session->userdata('role_id') == STUDENT && $this->session->userdata('class_id') == $obj->id){ ?>
                   ...
                   <?php if(has_permission(VIEW, 'gallery', 'gallery') || has_permission(VIEW, 'gallery', 'image')){ ?>     
                    ...
                    <li><a><i class="fa fa-lock"></i><?php echo $this->lang->line('profile'); ?> <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <?php if(!$this->session->userdata('is_default')){ ?>

                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                                <div class="box-header">
                                    <h3 class="box-title"><?php echo $this->lang->line('messages'); ?></h3>              
                                </div>
                                                ...
                                                <?php if(isset($messages) && !empty($messages)){ ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="mailbox-name">
                                                            <a href="<?php echo site_url('message/view/'.$obj->message_id); ?>"><?php $user = get_user_by_role($obj->role_id, $obj->sender_id); echo $user->name; ?></a>
                                                        </td>

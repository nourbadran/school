...
class Mark_Model extends MY_Model {
    ...
    public function get_student_list($school_id = null, $exam_id = null, $class_id = null, $section_id = null, $subject_id = null){
    ...
    public function get_student_list_by_class($school_id = null, $exam_id = null, $class_id = null){
    ...
    public function get_receiver_email($school_id, $role_id, $student_id){
        ...
        if($role_id == STUDENT){
            ...
            $this->db->where('S.$chool_id', $school_id);
        }else{
            $this->db->select('U.email');
            $this->db->from('users AS U'); 
    ...
    public function get_marks_list_by_student($school_id, $exam_id, $class_id, $student_id){

...
class Classtype extends MY_Controller {
    ...
    function __construct() {
        parent::__construct();
        $this->load->model('Classtype_Model', 'classes', true);
    ...
    public function index() {
        ...
        $this->data['classes'] = $this->classes->get_list('class_types', array(), '','', '', 'id', 'ASC');;

        $this->data['list'] = TRUE;
        $this->layout->title($this->lang->line('manage_class_type'). ' | ' . SMS);
        $this->layout->view('classtype/index', $this->data);
    ...
    public function add() {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                $insert_id = $this->classes->insert('class_types', $data);
                if ($insert_id) {
                    success($this->lang->line('insert_success'));

                    redirect('academic/classtype/index');
                } else {
                    error($this->lang->line('insert_failed'));
                    redirect('academic/classtype/add');
                }
            } else {
    ...
    public function edit($id = null) {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                $data = $this->_get_posted_class_data();
                $updated = $this->classes->update('class_types', $data, array('id' => $this->input->post('id')));
                ...
                if ($updated) {
                    ...
                    redirect('academic/classtype/edit/' . $this->input->post('id'));
                }
            } else {
                $this->data['class'] = $this->classes->get_single('class_types', array('id' => $this->input->post('id')));
            }
        }

        if ($id) {
            $this->data['class'] = $this->classes->get_single('class_types', array('id' => $id));
    ...
    public function delete($id = null) {
        ...
        if ($this->classes->delete('class_types', array('id' => $id))) {

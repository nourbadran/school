                               ...
                               <?php echo form_open(site_url('academic/classes/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 select2"  name="class_type_id"  id="add_type" required="required" >
                                            <option value="">--<?php echo $this->lang->line('type'); ?>--</option>

                                            <?php foreach($types as $obj ){ ?>
                                                <option value="<?php echo $obj->id; ?>" <?php echo isset($post['class_type_id']) && $post['class_type_id'] == $obj->id ?  'selected="selected"' : ''; ?>><?php echo $obj->name; ?></option>
                                            <?php } ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 select2"  name="class_type_id"  id="add_type" required="required" >
                                            ...
                                            <?php foreach($types as $obj ){ ?>
                                                <option value="<?php echo $obj->id; ?>" <?php if($class->class_type_id == $obj->id){ echo 'selected="selected"';} ?> ><?php echo $obj->name; ?></option>
                                            <?php } ?>
                                        </select>
                                        <div class="help-block"><?php echo form_error('class_id'); ?></div>
                                    </div>
